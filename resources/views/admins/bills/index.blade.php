        ...
        <div class="col-lg-8">
            ...
            <div class="col-xl-6 mb-xl-0 mb-4">
                ...
                <div class="overflow-hidden position-relative border-radius-xl">
                    <img src="https://demos.creative-tim.com/material-dashboard/assets/img/illustrations/pattern-tree.svg" class="position-absolute opacity-2 start-0 top-0 w-100 z-index-1 h-100" alt="pattern-tree">
                    ...
                    <div class="d-flex">
                        ...
                        <img class="w-60 mt-2" src="../assets/img/logos/mastercard.html" alt="logo">
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 mb-lg-0 mb-4">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="col-md-6 mb-md-0 mb-4">
                        ...
                        <img class="w-10 me-3 mb-0" src="../assets/img/logos/mastercard.html" alt="logo">
                    ...
                    <div class="col-md-6">
                        <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        <img class="w-10 me-3 mb-0" src="../assets/img/logos/visa.html" alt="logo">
    ...
    <div class="col-md-7 mt-4">
        ...
        <div class="card-body pt-4 p-3">
            ...
            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                ...
                <span class="mb-2 text-xs">Email Address: <span class="text-dark ms-sm-2 font-weight-bold"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="543b383d22312614362126263d203b7a373b39">[email&#160;protected]</a></span></span>
            ...
            <li class="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg">
                ...
                <span class="mb-2 text-xs">Email Address: <span class="text-dark ms-sm-2 font-weight-bold"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="0d61786e6c7e4d7e796263682079686e65236e6260">[email&#160;protected]</a></span></span>
                <span class="text-xs">VAT Number: <span class="text-dark ms-sm-2 font-weight-bold">FRB1235476</span></span>
                </div>
                <div class="ms-auto text-end">
                <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;"><i class="material-symbols-rounded text-sm me-2">delete</i>Delete</a>
            ...
            <li class="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg">
                ...
                <span class="mb-2 text-xs">Email Address: <span class="text-dark ms-sm-2 font-weight-bold"><a href="https://demos.creative-tim.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d4b1a0bcb5ba94b2bdb6b1a6fab7bbb9">[email&#160;protected]</a></span></span>
                <span class="text-xs">VAT Number: <span class="text-dark ms-sm-2 font-weight-bold">FRB1235476</span></span>
                </div>
                <div class="ms-auto text-end">
                <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;"><i class="material-symbols-rounded text-sm me-2">delete</i>Delete</a>
