<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand px-4 py-3 m-0" href="dashboard-2.html" target="_blank">
        <img src="{{ asset('client/img/logo/logo-cao-tuyet.png') }}" class="navbar-brand-img" width="26" height="26" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link {{ request()->routeIs('admin.users.*') ? 'active bg-gradient-dark text-white' : 'text-dark' }}" href="{{ route('admin.users.listUser') }}">
