    ...
    <div class="container product-detail-container">
        <div class="row">
            ...
            <div class="col-md-7">
                ...
                <div class="mb-3">
                    <label>Số lượng: {{ $product->variantProducts->sum('quantity') }}</label>
        ...
        <div style="background: #f8f8f8; border-radius: 8px; padding: 24px 24px 12px 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.03); border: 1px solid #f0f0f0; margin-bottom: 32px; margin-top: 30px;">
            ...
            <ul class="list-unstyled ms-2">
                ...
                <li style="font-size: 16px; padding: 7px 0; border-bottom: 1px dashed #e0e0e0; color: #333;"><strong style="min-width: 120px; display: inline-block; color: #555;">Trạng thái:</strong> 
                    @if ($product->is_new == 0)
                        Hàng mới
